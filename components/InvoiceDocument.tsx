...
const styles = StyleSheet.create({
  ...
  header:      { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 28, paddingBottom: 20, borderBottomWidth: 2, borderBottomColor: '#C1442F', borderBottomStyle: 'solid' },
  brandBlock:  { flexDirection: 'column' },
  brandName:   { fontSize: 22, fontFamily: 'Helvetica-Bold', color: '#C1442F', marginBottom: 2 },
  brandSub:    { fontSize: 9, color: '#9A8A7A', letterSpacing: 2, textTransform: 'uppercase' },
  invoiceTitle:{ fontSize: 22, fontFamily: 'Helvetica-Bold', color: '#C1442F', textAlign: 'right' },
  ...
  tableHeader: { flexDirection: 'row', backgroundColor: '#C1442F', padding: '8 12', borderRadius: 2, marginBottom: 1 },
  ...
  summaryTotal:{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 8, marginTop: 4, borderTopWidth: 1.5, borderTopColor: '#C1442F', borderTopStyle: 'solid' },
  totalLabel:  { fontSize: 12, fontFamily: 'Helvetica-Bold', color: '#C1442F' },
  totalVal:    { fontSize: 12, fontFamily: 'Helvetica-Bold', color: '#C1442F' },
  ...
  thankYou:    { fontSize: 11, color: '#C1442F', fontFamily: 'Helvetica-Bold' },
